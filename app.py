...
if uploaded_files:
    for uploaded_file in uploaded_files:
        ...
        # Determine class
        predicted_class = f'Good Outcome -(High chances of recovery)- CPC Score: {random.randint(0, 2)}' if prediction[0][0] >= 0.5 else f'Poor Outcome -(Poor chances of recovery)- CPC Score: {random.randint(3,5)}'
